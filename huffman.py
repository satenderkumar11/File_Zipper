...
class HuffmanCoding:
    ...
    def compress(self):
        ...
        print("Compressed and saved to", output_path)
        return output_path
    ...
    def decompress(self, input_path):
        ...
        print("Decompressed and saved to", output_path)
        return output_path


def main():
    print("Huffman Coding Compression and Decompression")
    file_path = input("Enter the path of the file to compress: ").strip()
    ...
    decompress_choice = input("Do you want to decompress the file? (yes/no): ").strip().lower()
    if decompress_choice == "yes":
